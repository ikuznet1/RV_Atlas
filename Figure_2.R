...
pdf(paste0('./output/', 'snUMAP.pdf'), width=5, height=5)
...
pdf(paste0('./output/', 'sn_Vln.pdf'), width=4, height=20)
p
dev.off()
...
pdf('./output/CM_prev_stacked.pdf',width=5,height=5)
...
library(ggpubr)
pdf('./output/clust_freq.pdf',width=12.5,height=5)
...
#All
pdf(paste0('./output/', 'sc_seurat_dit_bulk2rv.pdf'), width=7, height=4)
...
pdf(paste0('./output/', 'sc_seurat_trend.pdf'), width=6.75, height=2.5)
