...
ifnb.list <- readRDS('/Volumes/Extreme\ SSD/Final_Analysis/dataset_post_clipping_qc.rds')
...
saveRDS(ifnb.list, file = "/Volumes/Extreme\ SSD/Final_Analysis/dataset_pre_harmony_after_sctransform.rds")
...
rm('data11')
gc()
saveRDS(M1, file = "/Volumes/Extreme\ SSD/Final_Analysis/BroadData_Merge_SCTransform_with_Doublets.rds")
...
saveRDS(M1, file = "/Volumes/Extreme\ SSD/Final_Analysis/BroadData_Harmony_SCTransform_with_Doublets.rds")
