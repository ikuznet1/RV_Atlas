...
M1<-readRDS(file = "/Volumes/Extreme\ SSD/Final_Analysis/BroadData_Harmony_SCTransform_with_Doublets.rds")
...
saveRDS(cm,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/cm.rds")
write.table(colnames(cm), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/cm.tsv", sep="\t", quote=F, col.names=NA)
...
saveRDS(fb,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/fb.rds")
write.table(colnames(fb), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/fb.tsv", sep="\t", quote=F, col.names=NA)
  
write.table(c(colnames(cm),colnames(fb)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)
...
saveRDS(fb,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/ec.rds")
write.table(colnames(ec), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/ec.tsv", sep="\t", quote=F, col.names=NA)
  
write.table(c(colnames(cm),colnames(fb),colnames(ec)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)
...
endo <- endo%>% 
  ...
  FindClusters(resolution=1) %>% 
  identity()
saveRDS(endo,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/endo.rds")
write.table(colnames(endo), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/endo.tsv", sep="\t", quote=F, col.names=NA)
  
write.table(c(colnames(cm),colnames(fb),colnames(ec),colnames(endo)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)
...
saveRDS(adipo,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/adipo.rds")
write.table(colnames(adipo), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/adipo.tsv", sep="\t", quote=F, col.names=NA)
  
write.table(c(colnames(cm),colnames(fb),colnames(ec),colnames(endo),colnames(adipo)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)
...
saveRDS(myeloid,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/myeloid.rds")
write.table(colnames(myeloid), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/myeloid.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(colnames(cm),colnames(fb),colnames(ec),colnames(endo),colnames(adipo),colnames(myeloid)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)
...
saveRDS(sm,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/sm.rds")
write.table(colnames(sm), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/sm.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(sm)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)
...
neuro <- neuro%>% 
  ...
  FindClusters(resolution=1) %>% 
  identity() 
saveRDS(neuro,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/neuro.rds")
write.table(colnames(neuro), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/neuro.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(neuro)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)
...
epi <- epi%>% 
  ...
  FindClusters(resolution=1) %>% 
  identity() 
saveRDS(epi,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/epi.rds")
write.table(colnames(epi), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/epi.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(epi)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
#  FindClusters(resolution=1) %>% 
#  identity() 
saveRDS(ccl,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/lec.rds")
write.table(colnames(ccl), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/lec.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(ccl)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
pc <- pc%>% 
  ...
  FindClusters(resolution=1) %>% 
  identity() 
saveRDS(pc,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/pc.rds")
write.table(colnames(pc), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/pc.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(pc)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
nkt <- nkt%>% 
  ...
  FindClusters(resolution=1) %>% 
  identity() 
saveRDS(nkt,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/nkt.rds")
write.table(colnames(nkt), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/nkt.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(nkt)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
saveRDS(prolif,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/prolif.rds")
write.table(colnames(prolif), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/prolif.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(prolif)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
saveRDS(M1,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/dataset_post_r1.rds")
...
saveRDS(cm,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/cm.rds")
write.table(colnames(cm), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/cm.tsv", sep="\t", quote=F, col.names=NA)
write.table(colnames(cm), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(fb)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
saveRDS(ec,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/ec.rds")
write.table(colnames(ec), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/ec.tsv", sep="\t", quote=F, col.names=NA)
  
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(ec)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(endo)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(adipo)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
all<-read.table("/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t")
write.table(c(all[,2],colnames(myeloid)), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/all.tsv", sep="\t", quote=F, col.names=NA)  
...
saveRDS(ccl,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/ccl.rds")
write.table(colnames(ccl), file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/ccl.tsv", sep="\t", quote=F, col.names=NA)
...
saveRDS(M1,file = "/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/integrated_no_doublets.rds")
M1 <- PrepSCTFindMarkers(M1)
cm.markers <- FindMarkers(M1,ident.1=c('0','8','15'))
write.table(cm.markers, file="/Volumes/Extreme\ SSD/Final_Analysis/CellTypes/cm_genes.tsv", sep="\t", quote=F, col.names=NA)
